...
const About = () => {
    return (
        <React.Fragment>
            ...
            <Paragraph>La plongée devient alors une véritable passion et je passe très rapidement mon niveau 2 en mai 2006 pour continuer ma progression dans la foulée vers le N3, puis le N4 en juin 2008, et enfin l'initiateur un an plus tard.</Paragraph>
            ...
            <Paragraph>Les premiers résultats sont plutôt encourageants et au fur et à mesure de mon apprentissage des réglages manuels de l'appareil, le passage au reflex devient comme une évidence.</Paragraph>
            <Paragraph>Je passe donc au Nikon D90 en juillet 2009, en caisson Aquatica, toujours avec mon fidèle flash DS125, auquel je vais associer un DS160.</Paragraph>
            <Paragraph>Après 5 années passés avec mon D90, j'ai ensuite évolué vers le D7100 puis le D7200, qui partagent tous les deux le même caisson Aquatica.</Paragraph>
            <Paragraph>Entre temps, ce site est tout simplement né du désir de partager cette passion avec famille et amis, et c'est début 2022 que cette 6ème version a vu le jour...</Paragraph>
        </React.Fragment>
    )
}
